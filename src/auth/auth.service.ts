  ...
  async signUp(signUpDto: SignUpDto) {
    try {
      ...
      if (!findUser) {
        ...
        const html = getEmailContent(process.env.MAIL_REDIRECT_URL, createdUser.capcha)
        this.senderService.sendEmail({to: createdUser.email, subject: mailSubject, text: mailContent, html})
